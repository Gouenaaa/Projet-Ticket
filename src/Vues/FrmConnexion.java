    ...
    private void btnConnecterMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnConnecterMouseClicked
        if(txtLogin.getText().compareTo("") == 0){
            ...
            if(txtMdp.getText().compareTo("") == 0){
                lblErreur.setText("Veuillez saisir un mdp");
            }
            else{
                if(!fm.loginExiste(txtLogin.getText()) || !fm.mdpValide(txtLogin.getText(), txtMdp.getText())){
                    lblErreur.setText("Identifiants invalides");
                }
                else{
                    if(fm.isAdmin(txtLogin.getText())){
                        FrmAdmin frm = new FrmAdmin();
                        frm.setVisible(true);
                    }
                    else{
                        FrmUser frm = new FrmUser(txtLogin.getText().toString());
                        frm.setVisible(true);
                    }
                }
            }
