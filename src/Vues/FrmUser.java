...
public class FrmUser extends javax.swing.JFrame {
    ...
    private void btnModifierMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModifierMouseClicked
        if(tblTickets.getSelectedRow() < 0){
            ...
            String etatTicket = tblTickets.getValueAt(tblTickets.getSelectedRow(), 3).toString();
            if(etatTicket.compareTo(cboEtatsTickets.getSelectedItem().toString()) == 0){
                JOptionPane.showMessageDialog(this, "Veuillez choisir un autre état");
            }
            else{
                fm.updateEtat(idTicket, cboEtatsTickets.getSelectedItem().toString());
                while(dtmTickets.getRowCount()!=0){
                    dtmTickets.removeRow(0);
                    }
                for(Ticket t : fm.getTicketsByLogin(login)){
                    v = new Vector();
                    v.add(t.getIdTicket());
